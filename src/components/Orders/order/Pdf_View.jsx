                            ...
                            <div style={{ display: "flex" }}>
                              ...
                              >
                                <p style={{ fontSize: 12, whiteSpace: "wrap" }}>
                                  Golden Farms Vegetables &amp; Fruits Trading
                                  LLC Office 43-44, Al Fahidi, Bur Dubai, Dubai,
                                  Dubai, United Arab Emirates, 211860 TRN:
                                  100517855100003{" "}
                                </p>
                              </div>
                              <div>
                                <p style={{ fontSize: 12 }}>
                                  ...
                                  Territory of Dighomi Educational and
                                  Experimental Farm 0131 Tbilisi Georgia
                                </p>
                              </div>
                            </div>
                          </td>
